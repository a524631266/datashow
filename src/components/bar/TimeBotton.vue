<template>
    <a-button class="fa fa-clock-o button" aria-hidden="true" ref="floatbutton"  :class="movelock?'':'ondrag'" type="primary" @mouseleave="handlefloatLeaveButton" @click="showLeftBar" style="margin-bottom: 16px"  @mousedown="handlefloatdownButton" @mouseup="handlefloatupButton">
...
export default class TimeBotton extends Vue {
