 ...
 */
export const getCityMapIdByName = (name) => {
    return cityMap[name];
};
/**
 * 获取城市的地图id，用来动态加载地图数据
 ...
 */
export const getProvinceMapIdByName = (name) => {
    return proviceChinese2PinYin[name];
};
/**
 * 后去全国与省级别的配置
 ...
 */
export const getGeoChinaProvinceOptionConfig = (provincesArray, heatData, mapname, isCenter = true, geolimiter) => {
...
function filterPoint(points, geolimiter) {
    const data = points;
...
export const getGeoCityOptionConfig = (data, geolimiter) => {
